...
class MemeGenerator extends React.Component {
  ...
  render() {
    return (
      <div>
        {/* // Controlled form */}
        <form className="mt-4 flex justify-around" onSubmit={this.handleSubmit}>
          ...
          <button className="bg-blue-800 py-2 px-4 rounded-full text-white font-semibold">Generate</button>
        </form>
